...
layout_main = [[sg.Text('Welcome to ALP', justification='r', size=(30, 1))],
          ...
          [sg.In(disabled=True, text_color='black'), sg.FileBrowse()],
          [sg.Button('Translate')],
          [sg.Multiline(default_text='Here will be Python code', key='result', size=(60, 10))],
          [sg.Exit()]
          ]

layout_rules = [[sg.Text('Внимание! Перед использованием программы ознакомтесь с правилами!', justification='c', text_color='red')],
